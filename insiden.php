...
<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container-fluid">
        ...
        <button id="logoutButton" class="nav-link btn btn-link" data-bs-toggle="modal" data-bs-target="#logoutModal">
...
<div class="modal fade" id="logoutModal" tabindex="-1" aria-labelledby="logoutModalLabel" aria-hidden="true">
    ...
    <button type="button" class="btn custom-btn report" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fa-solid fa-pencil"></i></button>
...
<div class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <input type="time" id="waktu_berhenti" name="waktu_berhenti" class="form-control" required>
                        </div>
            </div>
