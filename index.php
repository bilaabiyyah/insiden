...
<head>
    ...
    <link rel="icon" href="assets/icon/lock-solid.ico" type="image/x-icon">
...
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="assets/icon/transmart-white.jpg" class="img-fluid" alt="Image">
            </div>
            <div class="col-md-6">
                ...
                <div class="copyright">
                    <p>&copy; 2023 PT.Trans Retail Indonesia
                </div>
            </div>
        </div>
    </div>
